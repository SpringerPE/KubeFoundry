...
var buildCmd = &cobra.Command{
	Use:           "build",
	Short:         "Build Kubevela application container image",
	Long:          `Build Kubevela Application container simulating CF staging in Docker`,
	RunE:          build,
	SilenceUsage:  true,
	SilenceErrors: false,
}
